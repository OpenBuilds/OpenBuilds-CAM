...
(function(root, factory) {
  ...
  function Bootoast(options) {
    ...
    ' + this.settings.icon + '
    this.$el = $('<div class="' + pluginName + ' alert alert-' + this.typeFor(this.settings.type) + '"><span class="bootoast-alert-container"><span class="bootoast-alert-content">' + this.content + '</span></span></div>');
